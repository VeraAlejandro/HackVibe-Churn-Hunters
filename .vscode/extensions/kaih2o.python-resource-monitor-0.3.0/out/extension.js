...
class PyRSMWebviewProvider {
    ...
    resolveWebviewView(webviewView, context, token) {
        ...
        // Set page
        let paneljs = webviewView.webview.asWebviewUri(vscode.Uri.file((0, path_1.join)(this.context.extensionPath, "webview", "panel.js")));
        var htmlText = fs
            .readFileSync((0, path_1.join)(this.context.extensionPath, "webview", "panel.html"))
            .toString();
    ...
    onDidSendMessage(message) {
        if (message.type === "event" && message.event === "process") {
            ...
            if (pidMonitors.size === 0) {
                webview === null || webview === void 0 ? void 0 : webview.postMessage({ type: "reset" });
            }
...
function activate(context) {
    ...
    context.subscriptions.push(vscode.window.registerWebviewViewProvider("python-resource-monitor.graphsView", new PyRSMWebviewProvider(context), { webviewOptions: { retainContextWhenHidden: true } }));
    // Commands
    ...
    context.subscriptions.push(vscode.commands.registerCommand("python-resource-monitor.rsmLength", () => {
        ...
        lengthbox.onDidAccept((e) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield (webview === null || webview === void 0 ? void 0 : webview.postMessage({
                    type: "length",
                    value: num,
                }));
    ...
    context.subscriptions.push(vscode.debug.registerDebugAdapterTrackerFactory("python", new PyDebugAdapterTrackerFactory(context)), vscode.debug.registerDebugAdapterTrackerFactory("debugpy", new PyDebugAdapterTrackerFactory(context)));
...
function postData(pid, key, time, value) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // .then()
            yield (webview === null || webview === void 0 ? void 0 : webview.postMessage({ pid, type: key, time, value }));
        }
        catch (_a) {
